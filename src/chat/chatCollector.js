...
class ChatCollector extends EventEmitter {
    constructor() {
        ...
        // GBA Pokemon command regex - matches both ! and / prefixes with all valid commands including hold
        this.commandRegex = /^[!/](up|down|left|right|a|b|start|select|l|r|release|hold[a-z]+(?:\s+\d+)?|(?:up|down|left|right)\d{1,3})$/i;
